/**
 * Tabelas do módulo Novas Ruas / Ruas de Entrega (idempotente).
 * Uso: dotenv -e .env -- pnpm --filter @workspace/scripts run migrate-delivery-streets
 */
...
async function main() {
  ...
  console.log("migrate-delivery-streets: OK");
  await pool.end();
}
