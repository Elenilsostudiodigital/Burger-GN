...
del /f /q "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\BurgerGN-PrintAgent.lnk" >nul 2>&1
del /f /q "%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup\BurgerGN-Print-Agent.vbs" >nul 2>&1
del /f /q "%LOCALAPPDATA%\BurgerGN\print-agent\create-startup-shortcut.ps1" >nul 2>&1
del /f /q "%LOCALAPPDATA%\BurgerGN\print-agent\register-autostart.vbs" >nul 2>&1
